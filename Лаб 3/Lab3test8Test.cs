...
public class Lab3test8Test {
  ...
  public void lab3test8() {
    ...
    driver.FindElement(By.CssSelector("app-pet-list:nth-child(1) .addNewVisit")).Click();
    {
      var element = driver.FindElement(By.CssSelector(".mat-datepicker-toggle-default-icon"));
